...
virtualMachineId="250"
templateName="file-server"
tmp_cores="4"
tmp_memory="4096"
...
## Create extra network for services (no extra network needed)
...
## Create the virtual harddrisk for data (no data drive needed)
